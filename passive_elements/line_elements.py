...
class TransmissionLine(SeriesElement):
    ...
    def __init__(self, z_series_seq0_ohm_per_km_si: complex, z_series_seq1_ohm_per_km_si: complex,
        ...
        z_series_seq0_ohm_si = (z_series_seq0_ohm_per_km_si * line_length_km)
        z_series_seq1_ohm_si = (z_series_seq1_ohm_per_km_si * line_length_km)
        z_series_seq2_ohm_si = (z_series_seq2_ohm_per_km_si * line_length_km)
